...
void GBS_USART_Buffer_Write(USART_buffer_t* buffer, uint8_t value)
{
    ...
    buffer->tail = (buffer->tail + 1)%128;
    if (buffer->size<128) buffer->size++;
}
